%% 不同分布式电源容量下，电压情况、越限数、各支路线损情况
%% 容量[0,100+1j*50,300+1j*100,800+1j*250,1200+1j*400,1600+1j*600,2000+1j*800,2500+1j*1000]

%% 下面尝试接入分布式电源

dgcapacity=[0,100+1j*50,300+1j*100,800+1j*250,1200+1j*400,1600+1j*600,2000+1j*800,2500+1j*1000]  %kW Kvar
dgposition=16;
dgcapacity=dgcapacity./10000;    %标幺值
d=zeros(1,8);
...
32  32 33 0.021275852	 0.033454874];%每条支路的阻抗值，按z=u^2/s=16.02756做标幺值换算
...
Pdg=real(dgcapacity(1,idg));
Qdg=imag(dgcapacity(1,idg));
Bus(dgposition,2)=Bus(dgposition,2)-Pdg;
Bus(dgposition,3)=Bus(dgposition,3)-Qdg;
...
figure(2)
 plot(Ploss*10000,'LineWidth',3.0')
 title('各支路线损情况')
 xlabel('支路编号')
 ylabel('支路线损(kW)')
 grid on
...
figure(1)
legend('0','100+j50','300+j100','800+j250','1200+j400','1600+j600','2000+j800','2500+j1000')
figure(2)
legend('0','100+j50','300+j100','800+j250','1200+j400','1600+j600','2000+j800','2500+j1000')
